<html>
    <head>
        <style>
            .bg {
                ...
                background-image: linear-gradient(rgba(0, 0, 0, 0.527),rgba(0, 0, 0, 0.5)) , url(img/img5.jpg);
                    width:100%;
                    height:100%;
    ...
    <body>
        <div class="bg">
            <h1 style="color:white;margin-left:66px;text-align:center;padding-top:22px;">PEG UNIVERSITY</h1>
              ...
              <div style="padding-top:54px;" >              
                <form action="attendance.php" method="GET" style="margin-left:44px;">
                    <label>
        ...
        <h1 style="color:white;padding-left:44px;">
            Your Attendance for this academic year is
        </h1>
        <?php
...
if(isset($_GET['username'])){
$sql = " SELECT attend FROM profile where name='$username'";
...
if(isset($_GET['username'])){     
    ...
    {      
        echo "<h2 style='color:white;margin-left:60px;'>" . $rows['attend']. "</h2>";
    }}
$mysqli->close();
}
?>
